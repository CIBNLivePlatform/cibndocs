...
CIBN live云视频解决方案，可帮助用户直接使用经过大规模验证的直播流媒体分发服务,通过CIBN live成熟的P2P技术大幅节省带宽，提供更优质的用户体验。开发者可通过SDK中简洁的接口快速同自有应用集成，实现Android设备上的视频P2P加速功能。
...
dependencies {
    // 加入下面依赖
    compile 'cn.cibn.p2p:libp2p:1.2.6'
    compile 'cn.cibn.p2p:libp2pimpl:1.2.7'  
}
```
...
感谢阅读本篇文档，希望能帮您尽快上手Android SDK的用法，再次欢迎您使用CIBN live P2P加速SDK！
